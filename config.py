...
KNOWLEDGE_BASE = [
    ...
    {"q": "发货后多久能到", "a": "同城一般1-2天，跨省一般2-4天，偏远地区可能延迟1-2天，具体以物流轨迹为准。", "category": "logistics_query"},
    {"q": "客服一直不回复怎么办", "a": "非常抱歉给您带来不好的体验！我会为您创建高优先级工单，客服主管将在2小时内回电处理。", "category": "complaint"},
    {"q": "退货后多久退款", "a": "仓库签收退货包裹并质检通过后，退款一般1-3个工作日原路返回。", "category": "return"},
    {"q": "发票抬头写错了怎么办", "a": "电子发票未开具前可在订单详情中重新申请；已开具的请联系客服作废后重新开具。", "category": "invoice"},
    {"q": "账号无法登录怎么办", "a": "请尝试通过手机验证码或邮箱重置密码。如仍无法登录，请提供账号绑定手机号，我为您转人工核实。", "category": "account"},
    {"q": "忘记密码怎么找回", "a": "您可以在登录页点击'忘记密码'，通过绑定手机号或邮箱重置密码，重置后请及时登录。", "category": "account"},
    {"q": "这款产品怎么使用", "a": "请参考包装内说明书或产品详情页'使用指南'。如仍有疑问，我可以把对应教程链接发给您。", "category": "product_consult"},
    {"q": "产品有哪些规格参数", "a": "规格参数以商品详情页为准，常见参数包括型号、尺寸、颜色和版本。需要我帮您核对具体商品吗？", "category": "product_consult"},
]
